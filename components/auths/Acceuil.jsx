        ...
        >
            {({ handleChange, handleBlur, handleSubmit, values,touched,errors,isValid }) => (
                <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1, backgroundColor: "white" }}>
                    ...
                    <Image style={{ height: HEIGHT / 2, position: "absolute", alignSelf: "center", top: "7%" }} resizeMethod="resize" source={require('../../assets/roselogo2.png')} />
                        ...
                        <View style={{ padding: 40 }}>
                            ...
                            >
                                ...
                                <View style={{ height: 100, justifyContent: "center", alignItems: "center" }}>
                                    <TouchableOpacity disabled={isValid} onPress={() => navigation.navigate('')} style={[styles(isValid).loginButton, styles(isValid).shadow]}>

    ...
    return (
        ...
        <SafeAreaView style={{ flex:1, backgroundColor: "white" }}>
            ...
            <View style={{ flexDirection: "column", backgroundColor: "white", height: "97%", position: "absolute", top: "5%", width: WIDTH * 0.8, paddingTop: 10 }}>
                ...
                <TouchableOpacity onPress={()=>nav.navigate("tabLayout")} style={{ height: 50, width: "70%", backgroundColor: tabInteret.length === 5 ? '#F63A6E' : "lightgray", marginTop: 1, alignContent: "center", alignItems: "center", borderRadius: 25, position: "absolute", bottom: 0, left: '25%' }}>
